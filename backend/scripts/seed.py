...
CORE_RESOURCES: list[dict] = [
    ...
    {"resource_key": "NAV_ORDER_API", "resource_name": "Navigation Order API", "resource_type": "API", "resource_group": "Administration", "permissions": ["READ", "UPDATE"], "http_method": "PUT", "api_path": "/api/v1/navigation/order", "microservice": "identity"},
