...
export const ROUTES = {
  ...
  workflowTaskDetail: '/workflow/tasks/:taskId',
  workflowInstances: '/workflow/instances',
  workflowInstanceDetail: '/workflow/instances/:instanceId',
...
export const ROUTE_PERMISSIONS = {
  ...
  [ROUTES.permissions]: { resource: RESOURCE_KEYS.permissionGrantApi, permission: PERMISSION_KEYS.read },
  ...
  [ROUTES.workflowTaskDetail]: { resource: RESOURCE_KEYS.workflowTaskDetailApi, permission: PERMISSION_KEYS.read },
  [ROUTES.workflowInstances]: { resource: RESOURCE_KEYS.workflowInstancesMenu, permission: PERMISSION_KEYS.view },
  [ROUTES.workflowInstanceDetail]: { resource: RESOURCE_KEYS.workflowInstanceDetailApi, permission: PERMISSION_KEYS.read },
