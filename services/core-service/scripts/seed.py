...
CORE_RESOURCES: list[dict] = [
    ...
    {"resource_key": "USER_CREATE_API", "resource_name": "Create User API", "resource_type": "API", "resource_group": "Identity", "permissions": ["EXECUTE"], "http_method": "POST", "api_path": "/api/v1/users", "microservice": "core-service"},
    {"resource_key": "USER_UPDATE_API", "resource_name": "Update User API", "resource_type": "API", "resource_group": "Identity", "permissions": ["EXECUTE"], "http_method": "PUT", "api_path": "/api/v1/users/{user_id}", "microservice": "core-service"},
    {"resource_key": "USER_DELETE_API", "resource_name": "Delete User API", "resource_type": "API", "resource_group": "Identity", "permissions": ["EXECUTE"], "http_method": "DELETE", "api_path": "/api/v1/users/{user_id}", "microservice": "core-service"},
    ...
    {"resource_key": "TENANT_ADMIN_ACCESS_MENU", "resource_name": "Tenant Admin Access", "resource_type": "MENU", "resource_group": "Administration", "permissions": VIEW_PERMISSION, "is_ui_visible": True, "ui_path": "/tenant-admin-access", "parent_resource_key": "ADMIN_MENU", "sequence_no": 4},
    {"resource_key": "NAV_PREVIEW_MENU", "resource_name": "Nav Preview", "resource_type": "MENU", "resource_group": "Administration", "permissions": VIEW_PERMISSION, "is_ui_visible": True, "ui_path": "/nav-preview", "parent_resource_key": "ADMIN_MENU", "sequence_no": 5},
    {"resource_key": "NAV_ORDER_MENU", "resource_name": "Navigation Order", "resource_type": "MENU", "resource_group": "Administration", "permissions": VIEW_PERMISSION, "is_ui_visible": True, "ui_path": "/navigation-order", "parent_resource_key": "ADMIN_MENU", "sequence_no": 6},
    {"resource_key": "COMPONENTS_MENU", "resource_name": "Components", "resource_type": "MENU", "resource_group": "SYSTEM", "permissions": ["VIEW", "READ"], "is_ui_visible": True, "ui_path": "/components", "icon": "widgets", "sequence_no": 49},
    {"resource_key": "WORKFLOW_MENU", "resource_name": "Workflow", "resource_type": "MENU", "resource_group": "Workflow", "permissions": VIEW_PERMISSION, "is_ui_visible": True, "ui_path": "/workflow/tasks", "icon": "workflow", "sequence_no": 45},
    {"resource_key": "WORKFLOW_START_MENU", "resource_name": "Start Task Workflow", "resource_type": "MENU", "resource_group": "Workflow", "permissions": VIEW_PERMISSION, "is_ui_visible": True, "ui_path": "/workflow/start", "icon": "workflow", "parent_resource_key": "WORKFLOW_MENU", "sequence_no": 10},
    {"resource_key": "WORKFLOW_TASKS_MENU", "resource_name": "My Pending Tasks", "resource_type": "MENU", "resource_group": "Workflow", "permissions": VIEW_PERMISSION, "is_ui_visible": True, "ui_path": "/workflow/tasks", "icon": "workflow", "parent_resource_key": "WORKFLOW_MENU", "sequence_no": 20},
    {"resource_key": "WORKFLOW_INSTANCES_MENU", "resource_name": "Workflow Instances", "resource_type": "MENU", "resource_group": "Workflow", "permissions": VIEW_PERMISSION, "is_ui_visible": True, "ui_path": "/workflow/instances", "icon": "workflow", "parent_resource_key": "WORKFLOW_MENU", "sequence_no": 30},
    {"resource_key": "WORKFLOW_START_API", "resource_name": "Start Workflow API", "resource_type": "API", "resource_group": "Workflow", "permissions": ["EXECUTE"], "http_method": "POST", "api_path": "/api/v1/workflow-runtime/start", "microservice": "workflow-service"},
    {"resource_key": "WORKFLOW_PENDING_TASKS_API", "resource_name": "Pending Workflow Tasks API", "resource_type": "API", "resource_group": "Workflow", "permissions": ["READ"], "http_method": "GET", "api_path": "/api/v1/workflow-runtime/tasks/pending", "microservice": "workflow-service"},
    {"resource_key": "WORKFLOW_TASK_DETAIL_API", "resource_name": "Workflow Task Detail API", "resource_type": "API", "resource_group": "Workflow", "permissions": ["READ"], "http_method": "GET", "api_path": "/api/v1/workflow-runtime/tasks/{task_id}", "microservice": "workflow-service"},
    {"resource_key": "WORKFLOW_TASK_ACTION_API", "resource_name": "Workflow Task Action API", "resource_type": "API", "resource_group": "Workflow", "permissions": ["APPROVE", "REJECT", "RETURN"], "http_method": "POST", "api_path": "/api/v1/workflow-runtime/tasks/{task_id}/action", "microservice": "workflow-service"},
    {"resource_key": "WORKFLOW_TASK_CLAIM_API", "resource_name": "Workflow Task Claim API", "resource_type": "API", "resource_group": "Workflow", "permissions": ["EXECUTE"], "http_method": "POST", "api_path": "/api/v1/workflow-runtime/tasks/{task_id}/claim", "microservice": "workflow-service"},
    {"resource_key": "WORKFLOW_TASK_REMINDER_API", "resource_name": "Workflow Task Reminder API", "resource_type": "API", "resource_group": "Workflow", "permissions": ["EXECUTE"], "http_method": "POST", "api_path": "/api/v1/workflow-runtime/tasks/{task_id}/reminder", "microservice": "workflow-service"},
    {"resource_key": "WORKFLOW_INSTANCE_DETAIL_API", "resource_name": "Workflow Instance Detail API", "resource_type": "API", "resource_group": "Workflow", "permissions": ["READ"], "http_method": "GET", "api_path": "/api/v1/workflow-runtime/instances/{instance_id}", "microservice": "workflow-service"},
    {"resource_key": "WORKFLOW_APPROVE_BTN", "resource_name": "Approve Task", "resource_type": "BUTTON", "resource_group": "Workflow", "permissions": VIEW_PERMISSION, "parent_resource_key": "WORKFLOW_TASKS_MENU"},
    {"resource_key": "WORKFLOW_REJECT_BTN", "resource_name": "Reject Task", "resource_type": "BUTTON", "resource_group": "Workflow", "permissions": VIEW_PERMISSION, "parent_resource_key": "WORKFLOW_TASKS_MENU"},
    {"resource_key": "WORKFLOW_CLAIM_BTN", "resource_name": "Claim Task", "resource_type": "BUTTON", "resource_group": "Workflow", "permissions": VIEW_PERMISSION, "parent_resource_key": "WORKFLOW_TASKS_MENU"},
    {"resource_key": "WORKFLOW_REMINDER_BTN", "resource_name": "Send Reminder", "resource_type": "BUTTON", "resource_group": "Workflow", "permissions": VIEW_PERMISSION, "parent_resource_key": "WORKFLOW_TASKS_MENU"},
    {"resource_key": "SETTINGS_MENU", "resource_name": "Settings", "resource_type": "MENU", "resource_group": "Administration", "permissions": VIEW_PERMISSION, "is_ui_visible": True, "ui_path": "/settings", "parent_resource_key": "ADMIN_MENU", "sequence_no": 7},
    {"resource_key": "AUDIT_LOG_MENU", "resource_name": "Audit Logs", "resource_type": "MENU", "resource_group": "Administration", "permissions": VIEW_PERMISSION, "is_ui_visible": True, "ui_path": "/audit-logs", "parent_resource_key": "ADMIN_MENU", "sequence_no": 8},
    {"resource_key": "ROLE_MANAGE_API", "resource_name": "Manage Roles API", "resource_type": "API", "resource_group": "Administration", "permissions": ["CREATE", "READ", "UPDATE", "DELETE"], "http_method": "POST", "api_path": "/api/v1/roles", "microservice": "core-service"},
    {"resource_key": "PERM_GRANT_API", "resource_name": "Permission Grants API", "resource_type": "API", "resource_group": "Administration", "permissions": ["READ", "CONFIGURE"], "http_method": "PUT", "api_path": "/api/v1/roles/{role_id}/permissions", "microservice": "core-service"},
    {"resource_key": "RESOURCE_MANAGE_API", "resource_name": "Manage Resources API", "resource_type": "API", "resource_group": "Platform", "permissions": ["CREATE", "READ", "UPDATE", "DELETE"], "http_method": "POST", "api_path": "/api/v1/resources", "microservice": "core-service"},
