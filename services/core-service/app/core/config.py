...
class Settings(BaseModel):
    ...
    jwks_enabled: bool = Field(default=False)
...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        jwt_private_key_path=os.getenv("JWT_PRIVATE_KEY_PATH") or None,
        jwt_public_key_path=os.getenv("JWT_PUBLIC_KEY_PATH") or None,
        jwks_enabled=os.getenv("JWKS_ENABLED", "false").lower() in {"1", "true", "yes", "on"},
